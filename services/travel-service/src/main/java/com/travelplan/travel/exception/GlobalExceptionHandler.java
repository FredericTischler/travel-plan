...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(InvalidTransportRequestException.class)
    public ResponseEntity<Map<String, Object>> handleInvalidTransportRequest(InvalidTransportRequestException ex) {
